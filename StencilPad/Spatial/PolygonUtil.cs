...
public static class PolygonUtil
{
    ...
    private static bool IntersectsArc(Arc arc, Unit2D point)
    {
        var lineStart = point;
        ...
        if (i0 is not null)
        {
            ...
            if (MathUtil.IsAngleBetween(angle, arc.StartAngle, arc.EndAngle))
            {
                return true;
            }
        }
    ...
    private sealed class EvenOddWalker : IGeometryWalker
    {
